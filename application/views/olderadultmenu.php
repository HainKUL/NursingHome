...
<div class="container-fluid">
    ...
    <div id="card_menu">
        ...
        <div class="row" id="second_row_m">
            <div class="col-1">
                <a href="<?=base_url()?>index.php/questionnaire_controller/poll">
            ...
            <div class="col-8" id="menu_text">
                <a href="<?=base_url()?>index.php/questionnaire_controller/poll">
                    <button id="menu_button">{second}</button>
                </a>
            </div>
    ...
    <div id="card_menu">
        ...
        <div class="row" id="fourth_row_m">
            ...
            <div class="col-8" id="menu_text">
                <a href="<?=base_url()?>index.php/Homepage_controller/sportsnews">
                    <button id="menu_button">{fourth}</button>
                </a>
            </div>
    ...
    <div id="card_menu">
        ...
        <div class="row" id="fifth_row_m">
            ...
            <div class="col-8" id="menu_text">
                <a href="<?=base_url()?>index.php/Homepage_controller/weathers">
                     <button id="menu_button">{fifth}</button>
                </a>
            </div>
