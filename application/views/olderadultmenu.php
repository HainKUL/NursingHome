...
<div class="container card" >
        <div class="row" >
            ...
            <div class="col-md-2">
                <a href="<?=base_url()?>index.php/Homepage_controller/home">
                    <button type = "button" class="button_logout">
        ...
        <div class="row" style="padding-top: 1%;padding-bottom: 1%">
            <div class="col-md-2"></div>
            <div class="col-md-8" >
                <a href="<?=base_url()?>Homepage_controller/news/<?php echo $_SESSION['id']?>">
                    <button type = "button" class="button_menu">
        ...
        <div class="row" style="padding-top: 1%;padding-bottom: 1%">
            <div class="col-md-2"></div>
            <div class="col-md-8" >
                <a href="<?=base_url()?>Homepage_controller/sportsnews/<?php echo $_SESSION['id']?>">
                    <button type = "button" class="button_menu">
        ...
        <div class="row" style="padding-top: 1%;padding-bottom: 1%">
            <div class="col-md-2"></div>
            <div class="col-md-8" >
                <a href="<?=base_url()?>Homepage_controller/weathers/<?php echo $_SESSION['id']?>">
                    <button type = "button" class="button_menu">
