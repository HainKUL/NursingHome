    ...
    <div id="card_menu">
        ...
        <div class="row" id="top_row_m">
            ...
            <div class="col-8" id="menu_text">
                <a href="<?=base_url()?>index.php/Questionnaire_controller/question\" class="btn btn-info" role="button" id="menu_button">
                    <p id="menu_text">{first}</p>
                </a>
            </div>
            <div class="col-2">
            </div>
